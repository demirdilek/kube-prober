...
test-alert-http: ## Simulate High Error Rate (HTTP 500)
	@./scripts/alerts/trigger-http.sh
...
test-alert-tls-expiry: ## Simulate TLS Certificate Expiry Alert
	@./scripts/alerts/trigger-tls-expiry.sh

test-alert-tls-handshake: ## Simulate TLS Handshake Failure Alert
	@./scripts/alerts/trigger-tls-handshake.sh
...
test-alert-all: ## Trigger all alerts
	@./scripts/alerts/trigger-all.sh
